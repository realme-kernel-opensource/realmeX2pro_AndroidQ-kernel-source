...
static bool oppo_usb_or_otg_is_present(void)
{
	...
	if (chip->pmic_spmi.smb5_chip->chg.typec_mode == POWER_SUPPLY_TYPEC_SINK
		...
		//chg_debug("chg->typec_mode = SINK,oppo_usb_or_otg_is_present return true!\n");
		return true ;
	}
...
#ifdef VENDOR_EDIT
	/*lizhijie@BSP.CHG.Basic, 2019/08/29, sjc Add for charging*/
